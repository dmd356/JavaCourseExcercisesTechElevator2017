...
public class Exercises {
	...
	public boolean cigarParty(int cigars, boolean isWeekend) {
		...
		else if(!isWeekend == true && cigars <= 40 || cigars >= 60){
				return false;
			}
	...
	public boolean squirrelPlay(int temp, boolean isSummer) {
		boolean range = temp <= 90 && temp >= 60;
		boolean rangeSummer = temp <= 100 && temp >= 60;
				
		if (!isSummer && range) {
			return true;
		}
		else if (isSummer && rangeSummer) {
			return true;
		}
		else {
			return false;
	...
	public int sortaSum(int a, int b) {
		int sum = a + b;
		boolean range = sum >= 10 && sum <= 19;
		boolean notRange = sum < 10 || sum > 19;
		if (range == true) {
			
			return 20;
		}
		else if(notRange == true){
	...
	public boolean specialEleven(int n) {
		boolean special = n % 11 == 0;
		boolean onePast = n % 11 == 1;
		if(special || onePast){
			return true;
		}
		else {
	...
	public boolean old35(int n) {
		boolean myNightmares = n % 3 == 0 && n % 5 != 0 || n % 3 != 0 && n % 5 == 0;
		if(myNightmares == true){
			return true;
		}
		else {
			return false;
	...
	public boolean nearTen(int num) {
		int mcLovinIt = num % 10;
		if(mcLovinIt <= 2 || mcLovinIt >= 8){
			return true;
		}
		else {
			return false;
	...
	public int teenSum(int a, int b) {
		int sum = a + b;
		boolean nachoLibre = a <= 19 && a >= 13 || b <= 19 && b >= 13;
		
		if (nachoLibre == true){
			return 19;
		}
		else if(nachoLibre == false){
			return sum;
		}
		else 
			return 0;
	...
	public int teaParty(int tea, int candy) {
		...
		boolean noBueno = tea < 5 || candy < 5;
		boolean chedda = tea * 2 <= candy  || candy * 2 <= tea;
