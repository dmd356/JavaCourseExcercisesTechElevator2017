...
public class CalculatorTest {
	...
	public static void main(String[] args) {
		...
		if(result != 4) {
			allTestsPassed = false;
			System.out.println("Test FAILED: The returned result should've been 4 raising it by 2 but it was "+result);
		}
		
		result = calculator.power(-2);
		if(result != 16) {
			allTestsPassed = false;
			System.out.println("Test FAILED: The returned result should be 16 after raising by -2 but was "+result);
		}
